...
#define AX_RAW_META_SIZE (4)
#define AX_NPU_BLOCK_COUNT (4)
#define AX_NPU_META_SIZE (4)
#define YUV_OS04A10_DEPTH (0)
#define YUV_GC4653_DEPTH (0)
#define YUV_GC5603_DEPTH (0)
#define YUV_SC1345_DEPTH (1)
#define YUV_SC530AI_DEPTH (0)
#define YUV_SC230AI_DEPTH (0)
#define YUV_NONLINK_DEPTH (1) // non-link: 1
#define YUV_IMX464_DEPTH (0)
#define YUV_IMX415_DEPTH (0)
#define AX_YUV_META_SIZE (4)
#define YUV_BLOCK_COUNT_ADDATION (1 + 1 + 1) // Redundant buf count
...
#define AX_AI_DETECT_FRAME_DEPTH (1)  // Frame depth
...
#define AX_VENC_IN_FIFO_DEPTH (0) // 0: use system default(1)
#define AX_VENC_OUT_FIFO_DEPTH (1) // 0: use system default(4)
...
#define YUV_GC5603_DEPTH (5)
#define YUV_SC1345_DEPTH (6)
#define YUV_SC530AI_DEPTH (5)
#define YUV_SC230AI_DEPTH (5)
#define YUV_IMX464_DEPTH (5)
#define YUV_IMX415_DEPTH (5)
#define YUV_NONLINK_DEPTH (1) // non-link: 1
#define AX_YUV_META_SIZE (4)
...
#define DETECTOR_ISP_GRP_NO (1) // use this channel to detect
#define DETECTOR_IVPS_CHANNEL_NO (1) // use this channel to detect
#define AX_AI_DETECT_FRAME_DEPTH (2)  // Frame depth
#define AX_AI_DETECT_CACHE_LIST_DEPTH (4) // Cache list depth
#define AX_AI_DETECT_FRAME_DEPTH_BLOCK_COUNT (AX_AI_DETECT_FRAME_DEPTH)
#define AX_AI_DETECT_CACHE_LIST_DEPTH_BLOCK_COUNT (AX_AI_DETECT_CACHE_LIST_DEPTH)
#define AX_AI_VENC0_USING_DETECTION (1) //0 or 1
#define AX_AI_VENC1_USING_DETECTION (1) //0 or 1
...
#define AX_VENC_IN_FIFO_DEPTH (2) // 0: use system default(4)
#define AX_VENC_OUT_FIFO_DEPTH (2) // 0: use system default(4)
...
#define AX_LOAD_BIN_ROOT "/opt/etc/"
#define AX_TAG_NONE_BIAS "nonebias"
