<template>
  <div>
    <el-form ref="formCameraRef" :rules="formCameraRules" :model="formCamera" label-width="220px">
      ...
      <el-form-item label="加载非BIAS模型:">
        <el-switch v-model="formCamera.camera_attr.nonebias" :disabled="!formCamera.camera_attr.nonebias_support"/>
      </el-form-item>
    ...
    async getInfo () {
      try {
        ...
        if (res.meta.status === 200) {
          ...
          this.formCamera.camera_attr.nonebias = res.data.camera_attr.nonebias
          this.formCamera.camera_attr.nonebias_support = res.data.camera_attr.nonebias_support
