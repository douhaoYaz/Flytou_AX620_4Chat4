...
typedef struct _stVideoConfig
{
    ...
    RC_INFO_T stRCInfoCBR; // CBR
    RC_INFO_T stRCInfoVBR; //VENC_RC_VBR and VENC_RC_AVBR
    AX_S32 nBitrate;
...
public:
    ...
    AX_BOOL UpdateRCParam(AX_U32 nRcType, AX_BOOL bRcTypeChange, AX_U32 u32MaxIprop);
    AX_BOOL ChangeRCType(AX_U32 nRcType, AX_U32 u32MaxIprop);
    AX_BOOL IsH265(AX_VOID) const { return m_bH265; }
...
protected:
    ...
    AX_VOID InitRcParam(AX_PAYLOAD_TYPE_E eType, AX_U32 nSrcFrameRate, const VIDEO_CONFIG_T& tConfig);
    AX_VOID StartRecv();
    AX_VOID StopRecv();
...
private:
    ...
    AX_VENC_H264_CBR_S   m_tH264Cbr{0};
    AX_VENC_H264_VBR_S   m_tH264Vbr{0};
    AX_VENC_H264_FIXQP_S m_tH264FixQp{0};
    AX_VENC_H265_CBR_S   m_tH265Cbr{0};
    AX_VENC_H265_VBR_S   m_tH265Vbr{0};
    AX_VENC_H265_FIXQP_S m_tH265FixQp{0};

    AX_BOOL              bEnableProcessFrame;
