...
AX_S32 AX_VIN_EXT_GetYuvFrame(AX_U8 pipe, AX_U8 yuv_chn, AX_IMG_INFO_T *ptImgInfo,
                              AX_S32 timeOutMs);
AX_S32 AX_VIN_EXT_ReleaseYuvFrame(AX_U8 pipe, AX_U8 yuv_chn, AX_IMG_INFO_T *ptImgInfo);
...
AX_S32 AX_VIN_EXT_GetFifoDepth(AX_U8 pipe, AX_U8 dev, AX_S32 dump_node);
AX_S32 AX_VIN_EXT_SetFifoDepth(AX_U8 pipe, AX_U8 dev, AX_S32 dump_node, AX_S32 nFifoDepth);
